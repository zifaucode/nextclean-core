        ...
        <form action="{{ route('admin.customer.update', $customer->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control @error('member_code') is-invalid @enderror" id="member_code" name="member_code" value="{{ old('member_code', $customer->member_code) }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('outlet_id') is-invalid @enderror" id="outlet_id" name="outlet_id">
                    ...
                    @foreach($outlets as $outlet)
                        <option value="{{ $outlet->id }}" {{ old('outlet_id', $customer->outlet_id) == $outlet->id ? 'selected' : '' }}>{{ $outlet->name }}</option>
                    @endforeach
                </select>
