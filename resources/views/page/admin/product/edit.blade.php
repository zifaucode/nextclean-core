...
@section('page_title', 'Form Edit Layanan Laundry')
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0">Edit Data Produk / Layanan</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.product.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            <option value="Kiloan" {{ old('type', $product->type) == 'Kiloan' ? 'selected' : '' }}>Kiloan (Per Kg)</option>
                            <option value="Satuan" {{ old('type', $product->type) == 'Satuan' ? 'selected' : '' }}>Satuan (Per Pcs/Item)</option>
                        </select>
