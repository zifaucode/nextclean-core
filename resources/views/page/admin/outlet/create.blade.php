...
@section('page_title', 'Tambah Outlet Baru')
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm" style="border-radius: 1rem;">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <h6 class="mb-0 text-primary fw-bold"><i class="bi bi-shop me-2"></i>Informasi Outlet</h6>
            </div>
                ...
                <form action="{{ route('admin.outlet.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control border-start-0 ps-0 @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: NextClean Cabang Utama" required>
                            @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="address" class="form-control border-start-0 ps-0 @error('address') is-invalid @enderror" rows="3" placeholder="Masukkan alamat lengkap outlet...">{{ old('address') }}</textarea>
                        </div>
                        @error('address')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" name="open_time" class="form-control border-start-0 ps-0 @error('open_time') is-invalid @enderror" value="{{ old('open_time') }}">
                            </div>
                            @error('open_time')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" name="close_time" class="form-control border-start-0 ps-0 @error('close_time') is-invalid @enderror" value="{{ old('close_time') }}">
                            </div>
                            @error('close_time')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" name="additional_fee" class="form-control border-start-0 ps-0 @error('additional_fee') is-invalid @enderror" value="{{ old('additional_fee', '0') }}">
                            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-2"></i>Simpan Outlet</button>
                    </div>
                </form>
            </div>
        </div>
