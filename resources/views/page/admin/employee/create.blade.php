    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm" style="border-radius: 1rem;">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <h6 class="mb-0 text-primary fw-bold"><i class="bi bi-person-badge me-2"></i>Informasi Karyawan</h6>
            </div>
                ...
                <form action="{{ route('admin.employee.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="employee_code" id="employee_code" class="form-control border-start-0 ps-0 @error('employee_code') is-invalid @enderror" value="{{ old('employee_code') }}" placeholder="Biarkan kosong untuk auto-generate">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="position" class="form-control border-start-0 ps-0 @error('position') is-invalid @enderror" value="{{ old('position') }}" placeholder="Contoh: Kasir">
                            </div>
                            @error('position')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="salary" class="form-control border-start-0 ps-0 @error('salary') is-invalid @enderror" value="{{ old('salary', 0) }}" min="0">
                            </div>
                            @error('salary')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-2"></i>Simpan Karyawan</button>
                    </div>
                </form>
            </div>
        </div>
